...
\begin{itemize}
  ...
  \item Selection principles and games
  \item Continuum theory
  \item Generalized inverse limits
  \vfill
  \columnbreak
  ...
  \item Active, team-based, and inquiry-based learning
\end{itemize}
\end{multicols}
...
\begin{itemize}
  ...
  \item
    ...
    (accepted to CMUC pending revisions)
  \item
    \textit{Almost compatible functions and topological games.}
    (accepted to RMJM pending revisions, with A. Dow)
  \item
...
\begin{itemize}
  ...
  \item
    \textbf{$\pi$-Base Encyclopedia of Topological Spaces}
