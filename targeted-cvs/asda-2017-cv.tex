...
\headerText{Professional Appointments}
\begin{itemize}
  \item
...
\headerText{Research Cyberinfrastructure and Software Development}
\begin{itemize}
  \item
  ...
  \item
    \textbf{$\pi$-Base Encylopedia of Topological Spaces}
  ...
  \item
    ...
    Developed the customer relationship management (CRM) web application
